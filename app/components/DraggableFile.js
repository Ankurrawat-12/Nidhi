...
export default function DraggableFile({ file, navigateToFolder, moveFile }) {
    ...
    return (
        <>
            ...
            {/* File Editor Modal */}
            {file.type === "file" && (
                <Dialog open={editorOpen} onClose={handleEditorClose} fullWidth>
                    ...
                    <DialogActions>
                        <Button onClick={handleEditorClose} color="secondary">Cancel</Button>
                        <Button onClick={handleSaveContent} color="primary">Save</Button>
                    </DialogActions>
                </Dialog>
            )}
        </>
